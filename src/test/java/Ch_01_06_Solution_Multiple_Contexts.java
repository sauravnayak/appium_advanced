...
public class Ch_01_06_Solution_Multiple_Contexts {
    ...
    private static final By WEBVIEW_PAGE = AppiumBy.accessibilityId("Webview Demo");
    private static final By URL_FIELD = By.xpath("//XCUIElementTypeTextField[@name=\"urlInput\"]");
    private static final By GO_BUTTON = AppiumBy.accessibilityId("navigateBtn");
    ...
    public void testHybridApp() {
        ...
        driver.context(getWebContext(driver));
        new WebDriverWait(driver, Duration.ofSeconds(10)).until(ExpectedConditions.titleContains("Appium Pro"));
    }
}
